...
# population = np.random.uniform(0, 5, size=(5, 2))  # Example: 10 individuals, 2 variables
...
# # Call GWO_Min
# result_position, result_fitness = GWO_Min(population, fitness_function, iterations=2, lower_bound=lower_bound, upper_bound=upper_bound)
